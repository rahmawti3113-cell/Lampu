...
String getHelpMessage(String name) {
  ...
  msg += "──────────────────\n";
  msg += "🔌 *Kontrol Relay:*\n";
  msg += "/relay1_on  - Relay 1 ON\n";
  msg += "/relay1_off - Relay 1 OFF\n";
  msg += "/relay2_on  - Relay 2 ON\n";
  msg += "/relay2_off - Relay 2 OFF\n";
  msg += "/relay3_on  - Relay 3 ON\n";
  msg += "/relay3_off - Relay 3 OFF\n";
  msg += "/relay4_on  - Relay 4 ON\n";
  msg += "/relay4_off - Relay 4 OFF\n";
  msg += "/all_on     - Semua Relay ON\n";
  msg += "/all_off    - Semua Relay OFF\n\n";
